...
exports.ContactPage = class ContactPage {
    ...
    async contactAdd(firstName, lastName, dateOfBirth, email, phone, address, city,state , post){
        await this.page. locator(this.addContact).click();
        await this.page. locator(this.firstName).fill(firstName);
        await this.page, locator(this.lastName).fill(lastName);
        await this.page.locator(this.dob).fill(date0fBirth);
   ...
   async validateContactCreated(fName, Name, dob, email, phone, address, city, state, postal,Country){
        const NameValidation =await this.page.locator(this.savedFirstName);
        const INameValidation =await this.page.locator(this.savedLastName);
        ...
        await expect(NameValidation).toHaveText(fName); await expect(INameValidation).toHaveText(Name);
